...
class RegionController extends AbstractController
{
     ...
     */
    public function index(EntityManagerInterface $em, PaginatorInterface $paginator, Request $request, RegionRepository $regionRepository): Response
    {

        $query = $regionRepository->selectWithFilter();
